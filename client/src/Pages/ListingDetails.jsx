      ...
      <div className="listing-details">
        ...
        <div className="photos">
          {listing.listingPhotoPaths?.map((item, index) => (
            <img key={index} src={`http://localhost:3001/${item.replace('public', '')}`} alt="listing" />
          ))}
        </div>
        ...
        <div className="profile">
          <img src={`http://localhost:3001/${listing.creator.profileImagePath.replace('public', '')}`} alt="Profile pic" />
